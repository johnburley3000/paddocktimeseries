    ...
    for i in range(len(S2_STEPS)):
        ...
        try:
            ...
            # Step 14: Estimate phenology (SAM)
                ...
                phenology_results = estimate_phenology(query, ds_yearly=ds_yearly, paddocks_filepath=gpkg_path)
            ...
            # Step 15: Estimate phenology (user)
                ...
                if paddocks_filepath is None:
                    ...
                    continue
                from PaddockTS.Phenology.estimate_phenology import estimate_phenology
                phenology_results_user = estimate_phenology(query, ds_yearly=ds_yearly_user, paddocks_filepath=paddocks_filepath)
